...
//http://wip4kjx.lyyytv.cn/d/file/0420f7046fd15ffe92b8fb994fa110d6/%E9%B2%A8%E9%BD%BF%E9%99%A9%E6%BB%A94K.mp4
	...
	lazy:`js:
		...
		//	play_Url = /bilibili/.test(input) ? 'https://jx.xmflv.com/?url=' : 'http://qn6z7b.yun.42jx.com/jx/jx.php?url='; // type0的parse
			 play_Url = /bilibili/.test(input) ? 'https://jx.xmflv.com/?url=' : 'json:http://qn6z7b.yun.42jx.com/jx/jx.php?url='; // type1的parse可加'json:'直接解析url (除了蜂蜜的'影视TV'，其它的壳皆可用)
			input = {
				jx: 1,
				url: input,
				playUrl: play_Url,
